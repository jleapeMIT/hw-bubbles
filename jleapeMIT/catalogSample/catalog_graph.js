function graph(){
    ...
    var padding = 6,
        ...
        color = d3.scale.category10().domain([minScore, maxScore]); //.domain([0, 12]);
    ...
    var minScore = Object.keys(nodes).reduce((a, b) => nodes[a] < nodes[b] ? a : b);
    var maxScore = Object.keys(nodes).reduce((a, b) => nodes[a] > nodes[b] ? a : b);
